...
<body>
  ...
  <header>
    ...
    <div class="headerUp">
      <div class="Up-dx">
        <img class="google" src="img.google.png" alt="logo google">
        <h2>Privacy e termini</h2>
      </div>
      
      <div class="Up-sx">
        <i class="fas fa-share-alt"></i>
        <img class="account-google" src="account.png" alt="logo account google">
      </div>
    ...
    <?php 
      ...
      $faq = [
        ...
        [
          ...
          'questions' => "Stabilire il paese associato al tuo account",
